...
```{r}
data.pc <- readRDS("/conf/EAVE/GPanalysis/data/temp/fail_to_mount_pc_Jan10_v3.rds")
data.bd <- readRDS("/conf/EAVE/GPanalysis/data/temp/fail_to_mount_bd_Jan10_v3.rds")
print (nrow(data.pc))
print (nrow(data.bd))
```

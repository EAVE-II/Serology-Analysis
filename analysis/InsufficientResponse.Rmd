...
```{r}
data.pc <- readRDS("/conf/EAVE/GPanalysis/data/temp/fail_to_mount_pc_Jan10_v4.rds")
data.bd <- readRDS("/conf/EAVE/GPanalysis/data/temp/fail_to_mount_bd_Jan10_v4.rds")
print (nrow(data.pc))
print (nrow(data.bd))
```
...
```{r}
output_folder <- file.path("results","QCOVID_FIX2")# Sys.Date())

...
bd.modelA.v4 <- readRDS('/home/calumm09/SerologyAnalysis/analysis/results/QCOVID_FIX2/modelA_bd_gamFit.rds')
```
...
```{r}
eavehelpers::display_ratios_table(pc.modelA.v4.or %>% rename(Nominal=OR))
```
